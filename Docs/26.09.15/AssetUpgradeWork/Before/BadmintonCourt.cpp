...
ABadmintonCourt::ABadmintonCourt()
{
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> Net(TEXT("/Game/Badminton/Prototype/M_Court_Net.M_Court_Net"));
	...
	for (int32 Index = 0; Index < 2; ++Index)
	{
		...
		AddBox(*FString::Printf(TEXT("NetPost%d"), Index), FVector(0, Sign * 305, 77.5), FVector(8, 8, 155), Lines.Object, true);
	}
	AddBox(TEXT("NetVisual"), FVector(0, 0, 115), FVector(3, 610, 76), Net.Object, false);
	AddBox(TEXT("NetTape"), FVector(0, 0, 154), FVector(4, 610, 3), Lines.Object, false);
