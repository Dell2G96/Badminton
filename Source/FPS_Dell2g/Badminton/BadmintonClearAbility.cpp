...
UE_DEFINE_GAMEPLAY_TAG(TAG_BadmintonReceiveEvent, "Event.Badminton.Receive");
UE_DEFINE_GAMEPLAY_TAG(TAG_BadmintonHairpinEvent, "Event.Badminton.Hairpin");
...
UBadmintonReceiveAbility::UBadmintonReceiveAbility() { SetShotTrigger(EBadmintonShot::Receive, TAG_BadmintonReceiveEvent); }
UBadmintonHairpinAbility::UBadmintonHairpinAbility() { SetShotTrigger(EBadmintonShot::Hairpin, TAG_BadmintonHairpinEvent); }
