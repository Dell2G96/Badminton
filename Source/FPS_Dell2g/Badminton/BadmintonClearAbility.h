...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_BadmintonReceiveEvent);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_BadmintonHairpinEvent);
...
UCLASS()
class FPS_DELL2G_API UBadmintonReceiveAbility : public UBadmintonClearAbility
{
	GENERATED_BODY()
public: UBadmintonReceiveAbility();
};

UCLASS()
class FPS_DELL2G_API UBadmintonHairpinAbility : public UBadmintonClearAbility
{
	GENERATED_BODY()
public: UBadmintonHairpinAbility();
};
